...
关于此类题目一些常用不等式的统一证明：
\begin{enumerate}
	\item \labeltext[［IEQ\ 1］]{［IEQ\ 1］$\mathbf{e^x\geqslant 1+x}$}{ieq1} \par
	...
	当仅当$x=0$时取等。
	 \item \labeltext[［IEQ\ 2］]{［IEQ\ 2］$\mathbf{\ln(1+x)\leqslant x}\ (x>-1),\mathbf{\ln(1+x)\geqslant x-\dfrac{x^2}{2}}\ (x\geqslant 0)$}{ieq2} \par
	...
	当仅当$x=0$时取等。
	\item \labeltext[［IEQ\ 3］]{［IEQ\ 3］$\mathbf{\ln x \leqslant 1-\dfrac{1}{x}}$}{ieq3} \par

...
\newenvironment{que}
	...
	\refstepcounter{no}\heiti{\textcolor{tsorange}{题目\ \padzeroes[3]{\decimal{no}}}}\ 
	} 
	{\end{tcolorbox}}
\newenvironment{thm}
	{\begin{tcolorbox}
...
\newcommand{\sol}{\blue{\raisebox{-0.09em}{\includegraphics[height=1em]{cat.png}}\ \heiti{解答}\ \ }}
...
\begin{titlepage}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.north west) [anchor=north west]{%
			\begin{tikzpicture}[remember picture,overlay]
				\node[anchor=south west,inner sep=0pt] at (2cm,-25cm)
				...
				\draw[anchor=south east, inner sep=0pt] (18cm,-27.5cm) node
				[black,
					ultra thick,
					%fill=,
					fill opacity=0.9,
